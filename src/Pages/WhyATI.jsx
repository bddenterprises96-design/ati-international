    ...
    <div className="bg-[#f7f9fb] min-h-screen">
      ...
      <section className="bg-[#005691] py-20 px-8">
        <div className="max-w-[1280px] mx-auto">
          <span className="inline-block px-3 py-1 bg-white/20 text-white text-xs font-semibold rounded mb-6 uppercase tracking-widest">Our Advantage</span>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Why Choose ATI International?</h1>
          <p className="text-white/80 text-lg max-w-2xl">Discover the key differentiators that make ATI International the preferred sealing solutions partner for manufacturers worldwide.</p>
        </div>
      </section>
      ...
      <section className="py-20 max-w-[1280px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <div key={item.title} className="bg-white border border-[#c5c6cd] rounded-xl p-8 flex gap-6 hover:shadow-md transition-shadow">
        ...
        <div className="max-w-[1280px] mx-auto px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={c.cert} className="border border-[#005691]/30 rounded-xl p-8 text-center hover:bg-[#005691]/5 transition-colors">
      ...
      <section className="py-20 max-w-[1280px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={t.company} className="bg-white border border-[#c5c6cd] rounded-xl p-8 hover:shadow-md transition-shadow">
