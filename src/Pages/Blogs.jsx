      ...
      <div className="max-w-[1280px] mx-auto px-8 py-20">
        ...
        <div className="mt-16 bg-[#005691] text-white rounded-2xl p-10 text-center">
          ...
          <div className="flex gap-3 max-w-md mx-auto">
            ...
            />
            <button className="bg-white text-[#005691] px-6 py-3 rounded-lg font-semibold text-sm hover:brightness-105 transition-all whitespace-nowrap cursor-pointer hover:scale-105 transition-transform duration-500">
              Subscribe
            </button>
          </div>
        </div>
